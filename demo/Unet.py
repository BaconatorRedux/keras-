...
from demo.CNN import cnn_predict
from demo.core import locate_and_correct
...
def unet_train():
    ...
    print("开始训练u-net")
    model.fit(X_train, y_train, epochs=100, batch_size=4)#epochs和batch_size看个人情况调整，batch_size不要过大，否则内存容易溢出
    model.save('unet1.h5')
    print('unet1.h5保存成功!!!')
